#!/bin/bash
##
## DESCRIPTION:   Recalibrate indel variant quality scores using known variant sites
##
## USAGE:         gatk.variantrecalibrator.wgs.indel.sh
##                                                      input.indel.vcf
##                                                      ref.fa
##                                                      mills_1000_goldstd.sites.vcf
##
## OUTPUT:        input.indel.vcf.recal input.indel.vcf.recal.tranches input.indel.recal.plots.R
##
